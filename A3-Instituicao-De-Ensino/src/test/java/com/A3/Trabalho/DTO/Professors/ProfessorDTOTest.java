...
public class ProfessorDTOTest {
    ...
    private ProfessorDTO professorDTO = new ProfessorDTO("Jenifer", "jenifer@gmail.com", "12345678910", "Mestre", Date.valueOf("1980-05-21"));
    ...
    void DTOToProfessor() {
        ...
        assertEquals(professor.getDate(), professorDTO.getDate());
    }
